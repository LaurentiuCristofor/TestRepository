...
public class AirportDataProcessor
{
    ...
    protected static final String OUTPUT_FILENAME = "airport-tiny.graphml";
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        output.write("\n");
        output.write("<!--airport data subset in graphml format; used for testing-->\n");
        output.write("\n");
        ...
        output.write("\n");
        output.write("  <graph id='airport-tiny' edgedefault='directed'>\n");
    ...
    protected static void processAirports() throws IOException, ParseException
    {
        ...
        while ((columns = parser.getNextColumns()) != null)
        {
            ...
            if (airportIata == null
                || (!airportIata.equals("AMS")
                    && !airportIata.equals("CDG")
                    && !airportIata.equals("JFK")
                    && !airportIata.equals("OTP")
                    && !airportIata.equals("SEA")))
            {
                System.out.println("Not a wanted airport; skipping record");
                continue;
            }
    ...
    protected static void processAirlines() throws IOException, ParseException
    {
        ...
        while ((columns = parser.getNextColumns()) != null)
        {
            ...
            if (airlineIata == null
                || (!airlineIata.equals("AA")
                    && !airlineIata.equals("AF")
                    && !airlineIata.equals("DL")
                    && !airlineIata.equals("KL")
                    && !airlineIata.equals("RO")))
            {
                System.out.println("Not a wanted airline; skipping record");
                continue;
            }
